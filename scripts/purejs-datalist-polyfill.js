...
(function(document) {
    ...
    function getOffsetParent(elem) {
        ...
        while( parent != document.body ) {
            var position = parent.currentStyle ? parent.currentStyle.position : window.getComputedStyle(parent).getPropertyValue('position');
            if( position.match(/(relative|absolute|fixed)/) ) {
                break;
            }
    ...
    function convert(input, datalist, listItems) {
        ...
        getOffsetParent(input).appendChild( fakeList );
